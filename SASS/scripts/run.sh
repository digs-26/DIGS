...
#                  mkdir -p "$output_root"
#                fi
#                trains=$(find ../../storage/json/$trainset -type f -name "*jsonl*")
#                parts=$(find ../../storage/json/$partset -type f -name "*jsonl*")
...
#                  --under $under \
#                  --over $over \
#                  --seed $seed 2>&1 | tee "$output_root/${trainset}_${partset}_${handleset}_under${under}_over_${over}_${seed}.log"
#              done
#            done
#          done
#        done
